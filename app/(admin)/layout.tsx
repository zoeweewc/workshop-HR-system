...
const navItems = [
  ...
  { href: '/admin/claims', label: 'Claims', icon: 'receipt' },
...
const icons: Record<string, React.ReactNode> = {
  ...
  banknote: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />,
      ...
      <aside className="w-56 bg-white border-r border-slate-200 flex flex-col fixed h-full">
        <div className="px-5 py-5 border-b border-slate-100">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <p className="font-bold text-slate-900 text-sm">FleetHR</p>
        ...
        <nav className="flex-1 px-3 py-4 space-y-1">
          {navItems.map((item) => (
            <Link
              key={item.href}
              href={item.href}
              className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-600 hover:bg-slate-50 hover:text-slate-900 transition-colors text-sm"
            >
